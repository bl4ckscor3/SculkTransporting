...
public record ItemSignalParticleOption(PositionSource destination, int arrivalInTicks, ItemStackTemplate stack) implements ParticleOptions {
	...
	public static final MapCodec<ItemSignalParticleOption> CODEC = RecordCodecBuilder.mapCodec(
			instance -> instance.group(
					...
					ItemStackTemplate.CODEC.fieldOf("stack").forGetter(p -> p.stack))
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, ItemSignalParticleOption> STREAM_CODEC = StreamCodec.composite(
            ...
            ItemStackTemplate.STREAM_CODEC, ItemSignalParticleOption::stack,
